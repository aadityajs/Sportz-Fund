...
<div id="tabledata" class="section" style="width: 630px; margin-top: 0;">
		...
		<table id="table">
			...
			<tr>
				...
				<td class="table_title"><?php if($nflgamedate[$i]['is_active']=='active'){ echo 'Completed';}else{ ?> <a href="<?php echo site_url("admin/score/edit/").'/'.$nflgamedate[$i]['game_id'].'/'.$nflgamedate[$i]['type']; ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>img/ico_chart_bar.png" alt="accepted"/></a><?php }?></td>
				<td>
