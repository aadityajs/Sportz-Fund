...
<div id="tabledata" class="section" style="width: 630px; margin-top: 0;">
		...
		<table id="table" cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<td class="table_date">
				<b>Page Title/Name </b>
					<input type="text" name="page_title" id="page_title" value="<?php echo (!empty($editPage) ? $editPage['page_title'] : ""); ?>" /> </td>
			...
			<tr>
				<td>
				<b>Content </b>
				<textarea rows="10" cols="85" name="content" id="content_1"><?php echo (!empty($editPage) ? $editPage['content'] : ""); ?></textarea>
           ...
           <tr>
           	  <td>
              	<b>&nbsp;</b>
               <input type="submit" name="pagesubmit" value="<?php echo ($this->uri->segment(3) == 'edit' ? 'Save' : 'Add'); ?> Page" class="noborder" /></td>
           </tr>
		</table>
