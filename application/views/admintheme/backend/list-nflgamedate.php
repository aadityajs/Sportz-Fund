...
<div id="tabledata" class="section" style="width: 630px; margin-top: 0;">
			<h2 class="ico_mug">NFL Game Date</h2>
		...
		<table id="table">
			...
			<tr>
				...
				<td class="table_date"><?php echo $nflgamedate[$i]['game_period']; ?></td>
				<td class="table_title"><?php echo ucfirst($nflgamedate[$i]['is_active']); ?></td>
				<td>
				<a href="<?php echo site_url("admin/gamedate/status/").'/'.$nflgamedate[$i]['is_active'].'/'.$nflgamedate[$i]['game_id'].'/'.$nflgamedate[$i]['type']; ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>img/accept.jpg" alt="accepted"/></a>
