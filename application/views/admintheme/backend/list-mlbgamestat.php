...
<div id="tabledata" class="section" style="width: 630px; margin-top: 0;">
			<h2 class="ico_mug">MLB Statistics</h2>
		...
		<table id="table">
			...
			<tr>
				...
				<td class="table_title"><?php if($mlbgamedate[$i]['is_active']=='active'){ echo 'Completed';}else{ ?> <a href="<?php echo site_url("admin/stat/edit/").'/'.$mlbgamedate[$i]['game_id'].'/'.$mlbgamedate[$i]['type']; ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>img/ico_chart_bar.png" alt="accepted"/></a><?php }?></td>
				<td><?php //if($mlbgamedate[$i]['is_active']=='active'){ echo 'Completed';}else{ ?> 
				<!--<a href="<?php //echo site_url("admin/stat/status/").'/'.$mlbgamedate[$i]['is_active'].'/'.$mlbgamedate[$i]['game_id'].'/'.$mlbgamedate[$i]['type']; ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>img/accept.jpg" alt="accepted"/></a> --><?php //} ?>
