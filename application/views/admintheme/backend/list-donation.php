...
<div id="tabledata" class="section" style="width: 630px; margin-top: 0;">
			<h2 class="ico_mug">All Donations</h2>
		...
		<table id="table">
			...
			<tr>
				...
				<td>
				<a href="<?php echo site_url("admin/donation/status/").'/'.$alldonation[$i]['is_active'].'/'.$alldonation[$i]['don_id']; ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>img/accept.jpg" alt="accepted"/></a>
				<!-- --><a href="<?php echo site_url("admin/donation/delete/").'/'.$alldonation[$i]['don_id']; ?>" onclick="return confirm('Are you sure to delete <?php echo $alldonation[$i]['orgname']; ?>?');"><img src="<?php echo $this->config->item('admin_theme_url')?>img/cancel.jpg" alt="cancel"/></a>
