...
<?php $url = $this->uri->segment(1)."/".$this->uri->segment(2)."/".$this->uri->segment(3);
		...
		<!--start body-->
		<section id="body">		
          <h1 align="center"><span><?=$contribute['page_title']?></span>
		  <?php
		...
		<!--end body-->	
		 ...
		 <div id="inline1" style="width:800px;height:auto;overflow:auto;">
			...
			<input name="cms_id" type="hidden" value="<?=$contribute['cms_id']?>" />
			<center>
			<p style="font: bold 14px/16px Arial, Helvetica, sans-serif; color: #000; padding: 0 0 0 15px; margin: 0;">Edit Contribute</p><br />
			
			<table>
			
			<tr><td>
			<label><p>Change Your Contribute:</p><br /></label>
			
			</td><td>
		   <textarea name="content"  id="content" class="textarea1" style="height:300px; width:500px;"><?=$contribute['content']?></textarea>
