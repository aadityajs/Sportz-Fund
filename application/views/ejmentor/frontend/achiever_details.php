	...
	<?php $url = $this->uri->segment(1)."/".$this->uri->segment(2)."/".$this->uri->segment(3);
               ...
               ?>
		<section id="body">		
           <h1>Achiever<span>Profile</span></h1>         	
                        	...
                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <!--<tr class="gray2">
                               ...
                               <tr class="gray2">
								...
								<form method="post" action="<?php echo site_url("achiever/is_submitted")?>" enctype="multipart/form-data">
								...
								<label>Your Profile has already been submitted.Now, you can search for mentors.</label>
								<?php }?>
								</form>
								<?php } ?>
								</td>
                        ...
                        <td width="260">
                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr class="gray2">
                                ...
                                <img src="<?php echo site_url()?>uploads/<?=$achivercoordi['image']?>" alt="" width="221" class="user_img2" height="228">
								<?php  } else { ?>
